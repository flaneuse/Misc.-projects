...
loadfonts()
df = read_excel('~/Documents/USAID/mini projects/Tranistion team HCTM - (Nick Vivio)/HCTM HR Flat File.xlsx', skip = 3)
...
waffle(df$n/10,  use_glyph = 'user', glyph_size = 7, rows = 30) + theme(legend.position = 'none') + 
  geom_text(aes(x = 10, y = 1, label = paste0(mech, ': ', n)), 
